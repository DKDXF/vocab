...
### 1.3 适用范围
本文档适用于 VocabMaster V1.0 版本的开发与维护，涵盖后端 API、前端交互、数据库设计及核心算法实现。
...
| review_step | INTEGER | DEFAULT 0 | 复习步骤（1-8 为艾宾浩斯节点） |
| stage_2_pass_count | INTEGER | DEFAULT 0 | 第二轮通过次数 |
